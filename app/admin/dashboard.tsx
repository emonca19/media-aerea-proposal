...
export default function AdminDashboard() {
  ...
  const approvedTurbines = mockTurbines.filter(
    (t) => t.status === "APPROVED"
  ).length;
  ...
  const progressPercentage = Math.round(
    (approvedTurbines / totalTurbines) * 100
  );
        ...
        <Card title="Estado de Turbinas">
          ...
          <View style={styles.turbineStats}>
            <View style={styles.turbineStat}>
              <View
                style={[styles.statusDot, { backgroundColor: "#fb923c" }]}
              />
            ...
            <View style={styles.turbineStat}>
              ...
              />
              <Text style={styles.turbineValue}>
                {totalTurbines - inspectedTurbines - approvedTurbines}
              </Text>
