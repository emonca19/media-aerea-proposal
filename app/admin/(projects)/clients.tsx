            ...
            <ScrollView style={styles.formContainer}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewClient({ ...newClient, contactName: text })
                  }
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  style={[
                    styles.input,
                    (showErrors || emailTouched) &&
                      (!newClient.contactEmail ||
                        !validateEmail(newClient.contactEmail)) &&
                      styles.inputError,
                  ]}
                  value={newClient.contactEmail}
                  onChangeText={(text) =>
                    setNewClient({ ...newClient, contactEmail: text })
                  }
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewClient({ ...newClient, contactPhone: text })
                  }
...
const styles = StyleSheet.create({
  ...
  addButton: {
    backgroundColor: "#3949ab", // Kept blue for primary action
    borderRadius: 12,
    padding: 14,
    flexDirection: "row",
    alignItems: "center",
  ...
  projectCard: {
    ...
    borderWidth: 1,
    borderColor: "#e2e8f0",
    backgroundColor: "#fff", // Added background for the card itself
  },
  projectContent: {
    // New style for the content previously in LinearGradient
    padding: 12,
  },
  projectHeader: {
    flexDirection: "row",
  ...
  projectInfoContainer: {
    // Renamed from projectInfo to avoid conflict
    // Add any specific styles for this container if needed
  },
  projectDate: {
    color: "#64748b",
    fontSize: 14,
  ...
  modalContent: {
    backgroundColor: "#fff", // Changed from gradient to solid white
