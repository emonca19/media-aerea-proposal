        ...
        >
          ...
          >
            ...
            {turbines.map(turbine => (
              ...
              >
                <Ionicons 
                  name={getMarkerIcon(turbine.status) as keyof typeof Ionicons.glyphMap} 
                  size={18} 
        ...
        <View style={styles.itemDetailCard}>
          ...
          <View style={styles.itemDetailContent}>
            <Text style={styles.itemDetailStatus}>
              Estado: {selectedItem.status ? selectedItem.status.charAt(0).toUpperCase() + selectedItem.status.slice(1) : 'N/A'}
            </Text>
            <TouchableOpacity 
