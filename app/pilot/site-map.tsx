...
const styles = StyleSheet.create({
  ...
  controlOption: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#e5e7eb', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8, marginRight: 8, borderWidth: 1, borderColor: '#d1d5db' },
  controlOptionActive: { backgroundColor: '#3b82f6', borderColor: '#2563eb' },
  controlOptionText: { fontSize: 13, color: '#4b5563', marginLeft: 6, fontWeight: '500' },
  controlOptionTextActive: { color: '#ffffff' },
  controlsDivider: { width: 1, height: 20, backgroundColor: '#d1d5db', marginHorizontal: 8 },
