...
import { StyleSheet as CompStyles, FlatList, Text, TouchableOpacity, View } from 'react-native';
...
const styles = CompStyles.create({
  card_container: { backgroundColor: '#fff', borderRadius: 8, padding: 16, marginBottom: 16 },
