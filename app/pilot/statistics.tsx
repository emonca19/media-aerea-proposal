...
// Datos simulados para la vista de semana
...
// Métricas y porcentajes para la vista semanal
const weeklyMetrics = {
  efficiency: 85,
  safety: 95,
  quality: 90,
...
// Datos simulados para la vista de mes
...
// Métricas y porcentajes para la vista mensual
...
// Datos simulados para la vista de año
...
// Métricas y porcentajes para la vista anual
const yearlyMetrics = {
  efficiency: 80,
  safety: 91,
  quality: 87,
...
const chartConfig = {
  ...
  paddingLeft: 0, // Corrected to number
  paddingRight: 0, // Corrected to number
};
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{
        ...
        padding: 4,
        position: 'absolute',
        top: 10, // Moved higher: fixed small margin from the top of the container
        left: 15,
        right: 15,
        zIndex: 10,
        elevation: 3,
      ...
      <ScrollView
        style={{
          flex: 1,
          marginTop: 60 // Espacio para el selector fijo (10 top + ~40 height + 10 gap = 60)
        }}
        showsVerticalScrollIndicator={false}
        contentContainerStyle={{ paddingHorizontal: 15, paddingBottom: 10, paddingTop: 10 }}>
        {/* Moved and Restyled Resumen de Rendimiento Section */}
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingBottom: 10,
    paddingTop: 0, // Sin padding superior adicional
  },
  ...
  periodSelectorContainer: { flexDirection: 'row', marginHorizontal: 20, backgroundColor: '#e2e8f0', borderRadius: 12, padding: 4, marginTop: 16 },  fixedPeriodSelectorContainer: {
    flexDirection: 'row',
    backgroundColor: '#e2e8f0',
    borderRadius: 12,
    padding: 4,
    position: 'absolute',
    top: 0, // Se ajustará dinámicamente en el componente
    left: 15,
    right: 15,
    zIndex: 100,
    elevation: 5, // Para asegurar que se vea por encima del contenido en Android
  },
  ...
  summaryContent: {}, // Empty as direct children are styled
