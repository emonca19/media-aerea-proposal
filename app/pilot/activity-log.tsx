...
const mockProjects = [
  {
    ...
    description:
      "Inspección trimestral de las turbinas del parque norte con drone DJI M300",
...
const mockDrones = [
  {
    ...
    serialNumber: "SN-M300-78451",
    batteryStatus: 85,
  },
  {
    id: "2",
    model: "DJI Phantom 4 Pro",
    serialNumber: "SN-P4P-45213",
    batteryStatus: 60,
  },
];
...
export default function ActivityLogScreen() {
  ...
  const handleStartActivity = () => {
    ...
    Alert.alert(
      "Actividad Iniciada",
      `Has comenzado: ${
        activityTypes.find((at) => at.type === selectedType)?.label ||
        selectedType
      }${
        selectedTurbine
          ? ` en ${mockTurbines.find((t) => t.id === selectedTurbine)?.name}`
          : ""
      }`
    );
            ...
            >
              {todayActivities.length > 0 ? (
                todayActivities.map((activity, index, arr) => {
                  ...
                  const isStartOfDay =
                    activity.notes &&
                    activity.notes.toLowerCase().includes("inicio de jornada");
                  if (isStartOfDay) {
                      ...
                      >
                        <View style={styles.dottedLineContainer}>
                          ...
                          <View style={styles.startDayBlock}>
                            ...
                            <Text style={styles.startDayHour}>
                  ...
                  const turbine = activity.turbineId
                  ...
                  const activityMarginBottom =
                    subActivities.length > 0 ? 12 : 6;
                  return (
                    <View
                      key={activity.id}
                      style={{
                        ...
                        alignItems: "flex-start",
                        minHeight: 100,
                        marginBottom: activityMarginBottom,
                        position: "relative",
                        width: "100%",
                      }}
                    >
                      ...
                      >
                        ...
                        <View
                          style={[
                            styles.fixedActivityCard,
                            { marginBottom: subActivities.length > 0 ? 6 : 0 },
                          ]}
                        >
                          {" "}
                          <View
                        ...
                        {subActivities.length > 0 &&
                          subActivities.map((sub, subIdx) => {
                            const subType = activityTypes.find(
                              (t) => t.type === sub.type
                            );
                            return (
                              <View
            ...
            <View style={styles.projectCard}>
              ...
              <View style={styles.projectStatus}>
                ...
                <Text style={styles.projectId}>
                  Contrato: {currentProject.contractId}
                </Text>
              </View>
              ...
              <View style={styles.projectTimeline}>
                <View style={styles.projectDate}>
                  ...
                  <Text style={styles.projectDateValue}>
                    {currentProject.startDate.toLocaleDateString("es-ES", {
                      day: "numeric",
                      month: "short",
                    })}
                  </Text>
                ...
                <View style={styles.projectDate}>
                  ...
                  <Text style={styles.projectDateValue}>
                    {currentProject.endDate.toLocaleDateString("es-ES", {
                      day: "numeric",
                      month: "short",
                    })}
                  </Text>
              ...
              <Text style={styles.turbinesTitle}>
                Turbinas ({mockTurbines.length})
              </Text>
