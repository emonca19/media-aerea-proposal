...
import { pilot } from '../dashboard/main-dashboard/dashboard-data';
        ...
        <View style={styles.card}>
          ...
          <View style={styles.quickActionsGrid}>
            <TouchableOpacity 
              ...
              onPress={() => router.push('/pilot/calendar/calendar')}
            >
            ...
            <TouchableOpacity 
              style={styles.quickActionItem}
              onPress={() => router.push('/pilot/support/support-chat')}
            >
            ...
            <TouchableOpacity 
              style={styles.quickActionItem}
              onPress={() => router.push('/pilot/statistics/statistics')}
            >
            ...
            <TouchableOpacity 
              style={styles.quickActionItem}
              onPress={() => router.push('/pilot/features/project-management/project-history')}
            >
