...
// Import dashboard styles from the new location
import { styles as globalFormStyles } from '../../dashboard/main-dashboard/dashboard-styles';
          ...
          [
            ...
            { 
              ...
              onPress: () => {
                ...
                router.push(`/pilot/preflight-checklist?turbineId=${selectedAssetId}` as any);
              }
            }
          ]
        );
