    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '92%', paddingHorizontal: 0, marginTop: 16, marginBottom: 8, gap: 12 }}>
          <TouchableOpacity style={{ flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#e5e7eb' }} onPress={() => router.push('/pilot/maps/site-map')}>
          ...
          <TouchableOpacity style={{ flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#e5e7eb' }} onPress={() => router.push('/pilot/turbines/turbines')}>
